...
from apps.shared.metadata_reader import MusicFile
...
class AudioFile(db.Model):
    ...
    def __init__(self, filename:str):
        super().__init__()
        meta = MusicFile(filename)
        self.title = meta.title
        self.artists = meta.artist
        self.album = meta.album
        self.album_artist = meta.album_artist
        self.track_lenght = meta.time
        self.file_name = filename
        self.present_on_filesystem = os.path.isfile(os.path.join(Config.FILE_DIR, filename))
