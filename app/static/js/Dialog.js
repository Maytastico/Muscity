class Dialog {
    ...
    static loadIcons(){
        let check = new Image();
        check.src = '/assets/icon/feather/check.svg';
    }
    /**
     * @param properties
    ...
    generateCloseButton(properties) {
        ...
        if (properties.hasOwnProperty("style")) {
            ...
            closeButton.style = "position:absolute;width:1.5em;height:1.5em;";
        }
    ...
    generateOverlay() {
        ...
        dialogOverlay.classList.add("center");
        dialogOverlay.classList.add("horizontalCenter");
        ...
        dialogContainer.classList.add("horizontalCenter");
    ...
    generateLoadingDialog() {
        ...
        loadingIcon.src = '/static/icons/feather/loader.svg';
        this.dialog.appendChild(loadingContainer).appendChild(loading).appendChild(loadingIcon);
    }
    ...
    /**
     * Adds an element to the overlay that contains a check icon to give feedback to the user.
     * You can imply that something was successful.
     */
    generateCheckDialog() {
        const check = document.createElement("section");
        check.dataset.name = "check";
        check.classList.add("center");
        check.classList.add("check");
        this.dialog.appendChild(check);
    }
